$(function () {
    ...
    var endpoint = '/job/getall' 
    var stats = (document.getElementById('status').value);

    if (stats != '' || stats != null) {
        endpoint = endpoint+'?status='+stats;
    }
        ...
        dtUserTable.on('processing.dt', function () {
            ...
            columnDefs: [
                ...
                
                {
                    ...
                    render: function (data, type, full, meta) {
                      return (
                        '<a href="' + window.location.protocol + '//' + window.location.host + '/job/detail/' + full["_id"] + '" style="color:blue;">View</a>'
                      );
                    }
                  }
                ...
                //             '<a href="' + window.location.protocol + '//' + window.location.host + '/job/edit/' + full["_id"] + '" class="dropdown-item">' +
    ...
    $(document).on('click', '.add-new', function () {
        window.location.href = `${window.location.protocol}//${window.location.host}/job/create`;
    });
