$(function () {
        ...
        },
        {
          ...
          render: function (data, type, full, meta) {
            return (
              ...
              'Details</a>' +
              '<a href="' + window.location.protocol + '//' + window.location.host + '/user/edit/' + full["_id"] + '" class="dropdown-item">' +
  ...
  $(document).on('click', '.add-new', function () {
    window.location.href = `${window.location.protocol}//${window.location.host}/user/create`;
  });
