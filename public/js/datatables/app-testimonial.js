$(function () {
    ...
    if (dtUserTable.length) {
        dtUserTable.on('processing.dt', function () {
            ...
            serverSide: true,
            ajax: {
                url: `${window.location.protocol}//${window.location.host}/testimonial/getall`,
                method: 'post',
            ...
            columnDefs: [
                {
                    ...
                    render: function (data, type, full, meta) {
                        return `<img style="max-height: 45px" src = "${window.location.protocol}//${window.location.host}/uploads/testimonial/${full['image']}">`;
                    }
                },
                {
                    targets: 1,
                ...
                },
                {
                    ...
                    sortable: false,
                    render: function (data, type, full, meta) {
                      if(full['message'].length > 40) {
                        return (full['message'].substring(0, 40))+" ...";
                    }
                      return (full['message']);
                    }
                  },
...

                {
                    ...
                    render: function (data, type, full, meta) {
                        return (
                            ...
                            '<a href="' + window.location.protocol + '//' + window.location.host + '/testimonial/edit/' + full["_id"] + '" class="dropdown-item">' +
    ...
    $(document).on('click', '.add-new', function () {
        window.location.href = `${window.location.protocol}//${window.location.host}/testimonial/create`;
    });
