$(function () {
    ...
    if (dtUserTable.length) {
        dtUserTable.on('processing.dt', function () {
            ...
            serverSide: true,
            ajax: {
                url: `${window.location.protocol}//${window.location.host}/skill/getall`,
                method: 'post',
            ...
            columnDefs: [
                ...
                },
                {
                    ...
                    render: function (data, type, full, meta) {
                        if(full['category']) {
                            return full['category_detail']['categoryName'];
                        } else {
                            return '-'
                        }
                ...
                },
                {
                    ...
                    render: function (data, type, full, meta) {
                        ...
                        // console.log($status);
                        return (
                            '<span class="badge rounded-pill skillStatusUpadte cursor-pointer ' +
...

                {
                    ...
                    render: function (data, type, full, meta) {
                        return (
                            ...
                            '<a href="' + window.location.protocol + '//' + window.location.host + '/skill/edit/' + full["_id"] + '" class="dropdown-item">' +
            ...
            responsive: {
                details: {
                    display: $.fn.dataTable.Responsive.display.modal({
                        header: function (row) {
                            var data = row.data();
                            return 'Details of ' + data['skillName'];
                        }
                    }),
                    type: 'column',
    ...
    $(document).on('click', '.add-new', function () {
        window.location.href = `${window.location.protocol}//${window.location.host}/skill/create`;
    });

    $(document).on('click', '.skillStatusUpadte', function () {
        ...
        swal.fire({
            ...
            if (result.value) {
                window.location.href = `${window.location.protocol}//${window.location.host}/skill/status-change/${elemID}`;
            }
        });
    });
    ...
    $(document).on('click', '.deleteUser', function () {
        ...
        swal.fire({
            ...
            if (result.value) {
                window.location.href = `${location.protocol}//${window.location.host}/skill/delete/${elemID}`;
            }
        });
    });
});
