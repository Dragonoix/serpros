$(function () {
    ...
    if (dtUserTable.length) {
        dtUserTable.on('processing.dt', function () {
            ...
            serverSide: true,
            ajax: {
                url: `${window.location.protocol}//${window.location.host}/city/getall`,
                method: 'post',
...

                {
                    ...
                    render: function (data, type, full, meta) {
                        return (
                            ...
                            '<a href="' + window.location.protocol + '//' + window.location.host + '/city/edit/' + full["_id"] + '" class="dropdown-item">' +
    ...
    $(document).on('click', '.add-new', function () {
        window.location.href = `${window.location.protocol}//${window.location.host}/city/create`;
    });
    ...
    $(document).on('click', '.categoryStatusUpadte', function () {
        ...
        swal.fire({
            ...
            if (result.value) {
                window.location.href = `${window.location.protocol}//${window.location.host}/city/status-change/${elemID}`;
            }
        });
    });
    ...
    $(document).on('click', '.deleteUser', function () {
        ...
        swal.fire({
            ...
            if (result.value) {
                window.location.href = `${location.protocol}//${window.location.host}/city/delete/${elemID}`;
            }
        });
    });
});
